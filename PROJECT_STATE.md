...
NONE. TASK-004 is approved for reusable handoff-prompt and protocol guidance only; it carries no version, installed-Skill synchronization, tagging or publication authority.
